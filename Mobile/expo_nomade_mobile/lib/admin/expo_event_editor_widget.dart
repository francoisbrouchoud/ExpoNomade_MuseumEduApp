...
import 'package:expo_nomade_mobile/widgets/latlng_selector_widget.dart';
...
import 'package:expo_nomade_mobile/widgets/year_selector_widget.dart';
...
class ExpoEventEditorWidget extends StatefulWidget {
  ...
  @override
  ExpoEventEditorWidgetState createState() => ExpoEventEditorWidgetState();
}

/// State class for the ExpoEventEditorWidget.
class ExpoEventEditorWidgetState extends State<ExpoEventEditorWidget> {
  @override
  void initState() {
    super.initState();
  }
